  ...
  'zh-CN': {
    translation: {
      ...
      analysis: {
        ...
        combinationHint:
          '主应用与浮层使用同一列表：组合胜率 > {{winRate}}%，协同影响 > {{synergy}}%。',
        thresholds: '推荐标准',
        minimumCombinationWinRate: '最低组合胜率',
        minimumSynergy: '最低协同影响',
        ...
        noCombinations:
          '当前候选没有同时达到 50 场、组合胜率 > {{winRate}}% 且协同影响 > {{synergy}}% 的 Pair / Triple 组合。',
      ...
      overlay: {
        ...
        fivePickScore: '5 选构筑评分',
        combinationEmpty: '暂无达到已配置推荐标准的 Pair / Triple 组合',
  ...
  en: {
    translation: {
      ...
      analysis: {
        ...
        combinationHint:
          'The app and overlay share one list: combination WR > {{winRate}}% and synergy impact > {{synergy}}%.',
        thresholds: 'Recommendation thresholds',
        minimumCombinationWinRate: 'Minimum combination WR',
        minimumSynergy: 'Minimum synergy impact',
        combinationSynergyHint:
        ...
        noCombinations:
          'No current Pair / Triple combination has 50 picks, combination WR > {{winRate}}%, and synergy impact > {{synergy}}%.',
      ...
      overlay: {
        ...
        fivePickScore: 'Five-pick build score',
        combinationEmpty:
          'No Pair / Triple combination meets the configured thresholds',
